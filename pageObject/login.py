...
class Login():
    ...
    startdate_box = "//android.view.View[@content-desc='14 October 2023']"
    okbutton = "android:id/button1"
    enddate = "com.questalliance.myquest:id/et_end_date_day"
    enddate_box = "//android.view.View[@content-desc='29 October 2023']"
    ...
    enter_startdate = "//android.view.View[@content-desc='28 October 2023']"
    ...
    enter_enddate = "//android.view.View[@content-desc='30 October 2023']"
    ...
    def open_applicaton(self):
        ...
        # time.sleep(2)
        self.driver.find_element(By.ID, self.textbox_username).send_keys("tibilfacilitator1@gmail.com")
        # time.sleep(2)
        self.driver.find_element(By.ID, self.textbox_password).send_keys("123456")
        # time.sleep(5)
    ...
    def learner_application(self):
        self.driver.find_element(By.ID, self.textbox_selection).click()
        # time.sleep(6)
        self.driver.find_element(By.ID, self.textbox_username).send_keys("tibillearner1@gmail.com")
        # time.sleep(6)
        self.driver.find_element(By.ID, self.textbox_password).send_keys("123456")
        # time.sleep(6)
        self.driver.hide_keyboard()
